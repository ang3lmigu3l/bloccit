...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "GET #show" do
    ...
    it "assign my_sponsored_post to @sponsored_post" do
      get :show, topic_id: my_topic.id, id: my_sponsored_post.id
  ...
  describe "GET new" do
   ...
   it "instantiantes @sponsored_post" do
     get :new, topic_id: my_topic.id
 ...
 describe "SPONSORED POST create" do
  ...
  describe "GET edit" do
    ...
    it "assigns sponsored post to be updated to @sponsored post" do
      get :edit, topic_id: my_topic.id, id: my_sponsored_post.id
  ...
  describe " PUT update" do
    ...
    it "redirects to the update sponsored post" do
      new_title = RandomData.random_sentence
      new_body = RandomData.random_paragraph
      new_price = 99
